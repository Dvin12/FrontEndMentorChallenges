...
export default function Info({ ip }) {
  return (
    <>
      {ip.length === 0 ? (
        <p className="absolute top-44 left-1/2 -translate-x-1/2 w-[90%] xl:w-[40%]  2xl:top-72    xl:px-12 bg-[#fff]   py-6 z-[500] rounded-xl gap-4 shadow-xl xl:py-12 text-center">
