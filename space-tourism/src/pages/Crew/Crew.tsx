...
export default function Crew() {
  ...
  return (
    ...
    >
      <section className="flex h-full flex-col  items-center justify-start px-6 py-24 md:items-start   md:justify-between  md:px-10 md:py-0 md:pt-48   xl:items-start xl:px-20 xl:pt-48 2xl:px-52  ">
