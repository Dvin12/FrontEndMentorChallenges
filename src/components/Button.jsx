  ...
  return (
    <button
      className={`px-4 py-3 xl:py-4 xl:px-6 rounded-md shadow-lg text-sm xl:text-base   font-medium ${
        ...
        color === "red" &&
        " xl:px-11 opacity-90 xl:py-3 shadow-lg hover:bg-[#fff] border-sRed border-[2px] tracking-wider hover:text-sRed duration-200 rounded-md bg-sRed xl:w-auto w-[80%] text-[#fff]"
      } ${
        color === "blue" &&
