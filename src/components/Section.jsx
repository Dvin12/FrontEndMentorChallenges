export default function Section() {
  return (
    <section className="p-6 w-full h-full flex flex-col items-center justify-center mt-28 text-darkViolet">
      <div className="w-36 items-center flex justify-center bg-grayBLue h-[1px]"></div>
      <h3 className="text-5xl font-dmSerifDisplay mt-10">We're different</h3>
      ...
      <div className="w-full bg-darkViolet text-vLightGray flex items-center justify-center my-32 flex-col relative overflow-hidden ">
        <span className="text-4xl text-center font-dmSerifDisplay px-6 py-14 z-20 ">
