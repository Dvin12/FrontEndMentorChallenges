...
export default function Header() {
  return (
    <header className="font-Poppins font-bold w-full h-full">
      ...
      <section className="flex items-center justify-center flex-col mt-32 px-2  ">
        <h2 className=" text-2xl font-extrabold text-center">
          Build The Community Your Fans Will Love
        </h2>
        <p className="text-center font-normal font-OpenSans my-5 text-sm">
