  ...
  return (
    <div className="w-full xl:order-first">
      <section className="flex flex-col items-center justify-center w-full h-full gap-8 my-8 xl:px-44 xl:my-0 xl:justify-end xl:items-start ">
        ...
        <div className="relative xl:w-[10.9rem] ">
          <img
            src="./assets/images/logo.svg"
            alt="company name"
            className="xl:w-full"
          />
          <span className="absolute xl:text-4xl  -top-3 xl:left-[29px] text-3xl left-[24px] tracking-[1px]  xl:tracking-[0.5px] text-veryLightGray ">
            manage
          </span>
        </div>
      </section>
